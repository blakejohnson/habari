...
<?php foreach ( $posts as $post ) {
	...
	if ( is_array( $post->tags ) && in_array( 'Asides', $post->tags ) ) {
     ...
     <div id="post-<?php echo $post->id; ?>" class="<?php echo $post_class; ?>">
      ...
      <div class="entry-head">
       ...
       <small class="entry-meta">
        <span class="chronodata"><abbr class="published"><?php echo $post->pubdate->out( 'F j, Y g:ia' ); ?></abbr></span><?php if ( $show_author ) { ?> by <?php echo $post->author->displayname; ?> <?php } ?>
